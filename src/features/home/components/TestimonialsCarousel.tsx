    ...
    <AnimatedSection className="bg-white/50 py-20 backdrop-blur-sm dark:bg-neutral-950/50">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        >
          {count > 1 && (
            <>
              <button
                ...
                onClick={() => paginate(-1)}
                className="hover:text-primary-700 hover:ring-primary-200 absolute start-0 top-1/2 z-10 flex size-10 -translate-x-2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-neutral-600 shadow-md ring-1 ring-neutral-200 dark:bg-neutral-900 dark:text-neutral-300 dark:ring-neutral-700 transition sm:-start-4 rtl:translate-x-2"
              >
                {isRtl ? (
              ...
              <button
                ...
                onClick={() => paginate(1)}
                className="hover:text-primary-700 hover:ring-primary-200 absolute end-0 top-1/2 z-10 flex size-10 translate-x-2 -translate-y-1/2 items-center justify-center rounded-full bg-white text-neutral-600 shadow-md ring-1 ring-neutral-200 dark:bg-neutral-900 dark:text-neutral-300 dark:ring-neutral-700 transition sm:-end-4 rtl:-translate-x-2"
              >
                {isRtl ? (
                  <ChevronLeft className="size-5" aria-hidden />
                ) : (
          ...
          <Quote className="text-primary-200 dark:text-primary-800 mx-auto mb-4 size-8" aria-hidden />
          ...
          <div className="relative min-h-56 overflow-hidden">
            <AnimatePresence mode="wait" custom={physicalForward} initial={false}>
              ...
              >
                <blockquote className="text-lg font-medium text-neutral-900 sm:text-xl dark:text-neutral-50">
                  “{t(current.quote)}”
                </blockquote>
